...
public class MyController {
    ...
    public String show(Model model, @PathVariable("username") String username){
        User user = getCurrentUser();
        CustomUser dbUser = userService.findByLogin(username);
    ...
    public String update(@RequestParam(required = false) String email,
        ...
        if(isAdmin(user) || id == customUser.getId()) {
            userService.updateUserById(id, email, phone, address);
        }
        return "redirect:/";
    }
