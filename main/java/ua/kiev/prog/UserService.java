...
public class UserService {
    ...
    @Transactional
    public void updateUserById(long id, String email, String phone, String address) {
        Optional<CustomUser> opUser = userRepository.findById(id);
        if (opUser.isEmpty())
            return;
    ...
    @Transactional
    public void updateUserByLogin(String login, String email, String phone, String address) {
